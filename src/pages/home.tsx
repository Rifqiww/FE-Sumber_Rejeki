...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* hero */}
      <section className="relative bg-primary text-white py-16 md:py-24 overflow-hidden min-h-screen mt-16">
        <div
          className="w-full h-screen bg-cover bg-center opacity-40 absolute top-0 left-0"
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0 md:pr-8 pl-12">
              <h1 className="text-xl font-lora md:text-2xl lg:text-3xl leading-tight mb-4">
                ...
                yang kamu mau disini, bukan hanya tradisional tetapi juga{" "}
                <span className="font-bold text-secondary">menyehatkan</span>
              </h1>
              <p className="text-md font-inter italic text-white opacity-70 mb-8">
                Find the traditional food or drink you want here, not only
                traditional but also healthy
              </p>
              <Link
                to="/menu"
      ...
      <section className="bg-primary py-5 px-20 flex gap-5">
        <div className="flex-row py-8">
          ...
          <div className="flex flex-col md:flex-row items-center gap-5 rounded-2xl w-full max-w-2xl">
            ...
            <div className="text-center md:text-left">
              <p className="text-white font-lora text-xl mb-3">
              ...
              {showPdf && (
                <div
                  className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-opacity duration-300 animate-fadeIn"
                  onClick={() => setShowPdf(false)}
                >
                  <div
                    className="bg-primary/95 rounded-xl shadow-2xl border-2 border-white/10 w-full max-w-5xl max-h-[90vh] flex flex-col overflow-hidden transform transition-all duration-300 scale-95 hover:scale-100"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <div className="flex justify-between items-center p-4 bg-primary/90 border-b border-white/10">
                      <h3 className="text-white text-2xl font-bold font-lora tracking-wide">
                        Sertifikat Halal
                      </h3>
                      <button
                        onClick={() => setShowPdf(false)}
        ...
        <div className="">
          <div className="flex flex-col mb-10">
            <h3 className="text-primary-light text-left font-cinzel font-bold text-5xl text-shadow text-shadow-x-3 text-shadow-y-3 text-shadow-[#75645A] mb-2">
              KATEGORI KAMI
            </h3>
          ...
          <div className="flex-row space-y-10">
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex flex-col w-96 gap-2">
                <h1 className="text-secondary font-lora text-4xl">
                  Makanan Tradisional
                </h1>
                <p className="text-white font-inter italic text-xl">
                  Masakan rumahan dengan cita rasa khas penuh rasa, bikin rindu
                  kampung halaman.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex flex-col w-96 gap-2">
                ...
                <p className="text-white font-inter italic text-xl">
                  Kesegaran yang menenangkan, hadir dari racikan sederhana penuh
                  makna.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-5">
              <div className="bg-[#7D9E3B] p-6 rounded-full mb-2">
                <img src={Cookie} alt="Makanan Berat" className="w-12 h-auto" />
              </div>
              <div className="flex flex-col w-96 gap-2">
                <h1 className="text-secondary font-lora text-4xl">
                  Jajanan & Cemilan
                ...
                <p className="text-white font-inter italic text-xl">
                  Cemilan ringan yang selalu cocok untuk menemani obrolan
                  santai.
                </p>
              </div>
            </div>
